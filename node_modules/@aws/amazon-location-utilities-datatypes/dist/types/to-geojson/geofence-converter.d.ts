import { GetGeofenceResponse, PutGeofenceRequest, BatchPutGeofenceRequest, ListGeofencesResponse } from "@aws-sdk/client-location";
 ...
 * ```
 */
export declare function geofencesToFeatureCollection(geofences: GetGeofenceResponse | PutGeofenceRequest | ListGeofencesResponse | BatchPutGeofenceRequest): FeatureCollection<Polygon>;
