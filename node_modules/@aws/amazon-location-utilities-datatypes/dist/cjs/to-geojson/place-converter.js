...
exports.placeToFeatureCollection = void 0;
 ...
 */
function placeToFeatureCollection(place, options) {
    if ("Results" in place) {
        const features = place.Results.map((result) => result && convertPlaceToFeature(result, options));
        return (0, utils_1.toFeatureCollection)(features);
    }
        ...
        return (0, utils_1.emptyFeatureCollection)();
    }
}
exports.placeToFeatureCollection = placeToFeatureCollection;
/**
 ...
 */
function convertPlaceToFeature(place, options) {
    var _a, _b, _c;
    const coordinates = (_b = (_a = place.Place) === null || _a === void 0 ? void 0 : _a.Geometry) === null || _b === void 0 ? void 0 : _b.Point;
    if (coordinates) {
        const placeClone = Object.assign({}, place);
        (_c = placeClone.Place) === null || _c === void 0 ? true : delete _c.Geometry;
        if ("PlaceId" in placeClone) {
            delete placeClone.PlaceId;
        }
        const properties = (options === null || options === void 0 ? void 0 : options.flattenProperties) ? (0, utils_1.flattenProperties)(Object.assign({}, placeClone)) : Object.assign({}, placeClone);
        const feature = {
            type: "Feature",
