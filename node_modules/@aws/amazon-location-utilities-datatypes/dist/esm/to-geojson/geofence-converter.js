 ...
 * ```
 */
export function geofencesToFeatureCollection(geofences) {
...
function geofenceToFeature(geofence) {
    if (geofence) {
        const result = convertGeometryToFeature(geofence === null || geofence === void 0 ? void 0 : geofence.Geometry, geofence);
        if (result) {
