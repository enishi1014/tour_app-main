 ...
 */
export function placeToFeatureCollection(place, options) {
    if ("Results" in place) {
...
function convertPlaceToFeature(place, options) {
    ...
    if (coordinates) {
        ...
        const properties = (options === null || options === void 0 ? void 0 : options.flattenProperties) ? flattenProperties(Object.assign({}, placeClone)) : Object.assign({}, placeClone);
        const feature = {
            type: "Feature",
