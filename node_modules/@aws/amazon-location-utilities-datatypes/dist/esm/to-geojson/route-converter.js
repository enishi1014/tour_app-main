 ...
 * ```
 */
export function routeToFeatureCollection(route, options) {
    const { Legs } = route;
 ...
 */
function convertRouteToFeature(route, options) {
    var _a;
    const processedLegs = route.Legs.map((leg) => { var _a; return (_a = leg.Geometry) === null || _a === void 0 ? void 0 : _a.LineString; }).filter((leg) => leg);
    let properties = {};
    if (options === null || options === void 0 ? void 0 : options.flattenProperties) {
        properties = flattenProperties(route.Summary, "");
    }
    else if (route.Summary) {
        properties.Summary = Object.assign(Object.assign({}, route.Summary), { RouteBBox: undefined });
    }
    delete properties.RouteBBox;
    return {
        type: "Feature",
        properties: properties,
        bbox: (_a = route.Summary) === null || _a === void 0 ? void 0 : _a.RouteBBox,
        geometry: {
            type: "MultiLineString",
