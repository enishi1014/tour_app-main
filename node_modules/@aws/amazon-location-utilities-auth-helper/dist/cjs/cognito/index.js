 ...
 */
async function withIdentityPoolId(identityPoolId, options) {
    const region = identityPoolId.split(":")[0];
    const credentialsProvider = (0, credential_providers_1.fromCognitoIdentityPool)(Object.assign(Object.assign({}, (options || {})), { identityPoolId, clientConfig: Object.assign(Object.assign({}, (options && options.clientConfig ? options.clientConfig : {})), { region }) }));
    let credentials;
        ...
        getMapAuthenticationOptions: () => ({
            transformRequest: (url) => {
                ...
                if (url.match("https://maps.(geo|geo-fips).(.*).amazonaws.com")) {
                    return {
                        url: signer_1.Signer.signUrl(url, region, {
